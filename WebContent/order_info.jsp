	...
	<div class="container">
		...
		<c:forEach items="${PreOrderList}" var="preorder">
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						<tr class="warning">
							<th colspan="5">订单编号:${preorder.id}</th>
						</tr>
						<tr class="warning">
							<th>图片</th>
							<th>商品</th>
						...
						<tr class="active">
							<td width="60" width="40%"><input type="hidden" name="id"
								value="22"> <img src="${preorder.product.pimage }" width="70"
								height="60"></td>
							<td width="30%"><a target="_blank"> ${preorder.pname}</a></td>
							<td width="20%">￥${preorder.product.shop_price}</td>
							<td width="10%">${preorder.quantity}</td>
							<td width="15%"><span class="subtotal">￥${preorder.subtotal}</span></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div style="text-align: right; margin-right: 120px;">
				商品金额: <strong style="color: #ff6600;">￥${PreOrderTotal}</strong>
			</div>
		...
		<div>
			...
			<form class="form-horizontal"
				style="margin-top: 5px; margin-left: 150px;" id = "orderForm" action="/Shop_Sys/orderlist" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="password" class="form-control" id="inputPassword3" name = "getter"
							placeholder="请输收货人">
					</div>
				</div>
				<div class="form-group">
